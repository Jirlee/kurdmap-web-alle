...
- [ ] Push notifications
- [ ] Mobile app (PWA → MAUI / React Native)
- [ ] Expand to Berlin, Hamburg, München
- [ ] Paid featured listings & advertising
- [ ] Community forum
...
|:--:|-----------|:------:|:------:|
| 1 | Solution & DB Setup | Week 2 | 🔲 Not Started |
| 2 | Auth System Working | Week 4 | 🔲 Not Started |
| 3 | API MVP (CRUD + Search) | Week 8 | 🔲 Not Started |
| 4 | Frontend MVP (Search + Detail) | Week 13 | 🔲 Not Started |
| 5 | Admin Panel MVP | Week 17 | 🔲 Not Started |
